package com.karthika.bloodbank.Donor;//for delete donor ID
...
import com.karthika.bloodbank.Admin.AdminPanel;
...
public class DeleteDonor extends JFrame implements ActionListener
{
	...
	{
		super("Eliminate com.arnabb.bbms.Donor.Donor");
		...
		numberLabel = new JLabel("Enter com.arnabb.bbms.Donor.Donor ID ");
		...
		Object[] column = {"com.arnabb.bbms.Donor.Donor ID","Name","Blood Group", "City", "Contact", "Mail" };
