package com.karthika.bloodbank.Donor;//try / gui 4 / donor
...
import com.karthika.bloodbank.Login.Register;
...
public class Donor extends JFrame implements MouseListener, ActionListener {
	...
	public Donor() {
		...
		reg = new JLabel ("Register Yourself As a Donor");
