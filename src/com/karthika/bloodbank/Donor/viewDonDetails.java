package com.karthika.bloodbank.Donor;//view donor details from donor panel
...
public class viewDonDetails extends JFrame implements MouseListener, ActionListener {
	...
	private JButton regButton, cancelButton, importButton, updateButton;
	...
	public viewDonDetails(String lID) {

		super("BBMS :: View Details");
		...
		hivTF.setBounds(380,375,170,25);
		...
		smkTF.setBounds(380,400,170,25);
		smkTF.setEditable(false);
		panel.add(smkTF);

		drg = new JLabel("Drugs Addiction ?");
		drg.setBounds(40, 430, 300, 30);
		...
		drgTF.setBounds(380,430,100,25);
		...
		expTF.setBounds(380, 460, 100, 25);
	...
	public void showData(){
	    ...
	    public void actionPerformed(ActionEvent ae) {
			...
			if(elementText.equals(cancelButton.getText())){
				...
				try{
					//com.arnabb.bbms.Search.Update up = new com.arnabb.bbms.Search.Update();//new com.arnabb.bbms.Search.Update(lID);
			...
			/*else if(elementText.equals(updateButton.getText())){
				...
				try{
					...
					com.arnabb.bbms.Search.Update up = new com.arnabb.bbms.Search.Update(lID);
					up.setVisible(true);
					this.setVisible(false);
				}
