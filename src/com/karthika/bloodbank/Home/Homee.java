package com.karthika.bloodbank.Home;//try / gui 1 / homee
...
import com.karthika.bloodbank.Login.Login;
import com.karthika.bloodbank.Search.SearchInfo;
import com.karthika.bloodbank.Search.Stock;
...
public class Homee extends JFrame implements MouseListener, ActionListener {
	...
	public Homee() {
		...
		b4 = new JButton ("Stock Available");
