package com.karthika.bloodbank.Search;// stock
...
import com.karthika.bloodbank.Home.Homee;
...
public class Stock extends JFrame implements ActionListener
{
	...
	public Stock () 
	{
		super("com.karthika.bloodbank.Search.Stock Available");
		...
		title  = new JLabel ("Available In com.bloodbank.bloodbank.Search.Stock");
		...
		Object[] column = {"Blood Group","In com.karthika.bloodbank.Search.Stock (bags)"};
